...
Data profiling, integrity validation, wrangling and analysis on a financial transactions dataset for AML (anti-money laundering) analysis.

> **Note:** This is Part 1 of an ongoing project. This phase covers profiling and structural integrity validation of the data before modeling. The detection and typology-analysis phases will follow.
>
> The full code for this phase is available in the accompanying Jupyter notebook in this repository. This README explains the reasoning and findings; the notebook contains the code and outputs.
